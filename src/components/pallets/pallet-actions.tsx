...
import type { Pallet, ProductBatch } from "@/lib/types";

const INITIAL_STATE: UpdatePalletState = { error: null, success: null };

export function PalletActions({ pallet, existingBatches }: { pallet: Pallet; existingBatches: ProductBatch[] }) {
